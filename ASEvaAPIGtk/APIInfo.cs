 ...
 * \~English This document corresponds to API version: 2.11.3 \n\n
 * \~Chinese 本文档对应API版本：2.11.3 \n\n
 * 
...
namespace ASEva.UIGtk
{
    ...
    public class APIInfo
    {
        ...
        {
            return new Version(2, 11, 3, 0); // Update log / 更新记录: 修正GLView/SkiaView和WebView间的兼容性问题
        }
    }
}
