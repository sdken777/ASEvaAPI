 ...
 * \~English This document corresponds to API version: 3.2.2 \n\n
 * \~Chinese 本文档对应API版本：3.2.2 \n\n
 * 
...
namespace ASEva.UIGtk
{
    ...
    public class APIInfo
    {
        /// \~English
        /// <summary>
        /// (api:gtk=3.0.0) Get API version
        /// </summary>
        /// <returns>The API version</returns>
        /// \~Chinese
        /// <summary>
        /// (api:gtk=3.0.0) 获取API版本
        /// </summary>
        /// <returns>API版本</returns>
        public static Version GetAPIVersion()
        {
            return new Version(3, 2, 2, 1); // Update log / 更新记录: 修正X11OffscreenView的dummy box背景色问题
        }
    }
}
