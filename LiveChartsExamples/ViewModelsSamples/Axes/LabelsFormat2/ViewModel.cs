...
public partial class ViewModel : ObservableObject
{
    ...
    public Axis[] YAxes { get; set; } =
    {
        new Axis
        {
            ...
            {
                Color = SKColors.Blue,
                FontFamily = Index.AlwaysUseDefaultFont ? null : "Times New Roman",
                SKFontStyle = Index.AlwaysUseDefaultFont ? null : new SKFontStyle(SKFontStyleWeight.ExtraBold, SKFontStyleWidth.Normal, SKFontStyleSlant.Italic)
            },
        }
    };
}
