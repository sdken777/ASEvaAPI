 ...
 * \~English This document corresponds to API version: 1.5.1 \n\n
 * \~Chinese 本文档对应API版本：1.5.1 \n\n
 * 
...
namespace ASEva.UIMonoMac
{
    ...
    public class APIInfo
    {
        ...
        {
            return new Version(1, 5, 1, 0); // Update log / 更新记录: GLView和SnapshotHandler支持高DPI。修正object cannot be nil异常
        }
    }
}
