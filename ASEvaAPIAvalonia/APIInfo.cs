 ...
 * \~English This document corresponds to API version: 1.4.2 \n\n
 * \~Chinese 本文档对应API版本：1.4.2 \n\n
 * 
...
namespace ASEva.UIAvalonia
{
    ...
    public class APIInfo
    {
        ...
        {
            return new Version(1, 4, 2, 0); // Update log / 更新记录: 新增WindowExtensions.GetStorageProvider。新增App.IsVisualActive。修正Snapshot异常。App.RunDialog和App.ShowMessageBox可使用定制化的AvaloniaDialogHandler解决
        }
