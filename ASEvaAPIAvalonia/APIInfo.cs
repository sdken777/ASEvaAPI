 ...
 * \~English This document corresponds to API version: 1.0.4 \n\n
 * \~Chinese 本文档对应API版本：1.0.4 \n\n
 * 
...
namespace ASEva.UIAvalonia
{
    ...
    public class APIInfo
    {
        ...
        {
            return new Version(1, 0, 4, 0); // Update log / 更新记录: AvaloniaApplication增加Button.hyperlink style
        }
