 ...
 * \~English This document corresponds to API version: 1.4.0 \n\n
 * \~Chinese 本文档对应API版本：1.4.0 \n\n
 * 
...
namespace ASEva.UIAvalonia
{
    ...
    public class APIInfo
    {
        ...
        {
            return new Version(1, 4, 0, 0); // Update log / 更新记录: 新增AvaloniaApplicationSimpleRoundTheme
        }
