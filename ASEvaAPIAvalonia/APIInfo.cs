 ...
 * \~English This document corresponds to API version: 1.0.1 \n\n
 * \~Chinese 本文档对应API版本：1.0.1 \n\n
 * 
...
namespace ASEva.UIAvalonia
{
    ...
    public class APIInfo
    {
        ...
        {
            return new Version(1, 0, 1, 0); // Update log / 更新记录: 包括CustomMessageBox.Avalonia。初始化时设置lifetime
        }
