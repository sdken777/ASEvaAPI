 ...
 * \~English This document corresponds to API version: 2.12.1 \n\n
 * \~Chinese 本文档对应API版本：2.12.1 \n\n
 * 
...
namespace ASEva.UIEto
{
    ...
    public class APIInfo
    {
        ...
        {
            return new Version(2, 12, 1, 0); // Update log / 更新记录: CheckbleListBox, SimpleTreeView, TextTableView使用GridColumn.Expand
        }
