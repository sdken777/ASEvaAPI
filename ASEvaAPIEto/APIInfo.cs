 ...
 * \~English This document corresponds to API version: 3.3.1 \n\n
 * \~Chinese 本文档对应API版本：3.3.1 \n\n
 * 
...
namespace ASEva.UIEto
{
    ...
    public class APIInfo
    {
        ...
        {
            return new Version(3, 3, 1, 0); // Update log / 更新记录: 新增StackLayoutAddControlExtension, TableLayoutAddControlExtension, SetContentAsControlExtension, OverlayLayoutAddControlExtension
        }
