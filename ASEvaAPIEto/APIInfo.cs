 ...
 * \~English This document corresponds to API version: 2.13.3 \n\n
 * \~Chinese 本文档对应API版本：2.13.3 \n\n
 * 
...
namespace ASEva.UIEto
{
    ...
    public class APIInfo
    {
        ...
        {
            return new Version(2, 13, 3, 0); // Update log / 更新记录: 增加FlowLayout/2D.Selectable。并改良DefaultFlowLayout/2DBackend的边框实现方式
        }
