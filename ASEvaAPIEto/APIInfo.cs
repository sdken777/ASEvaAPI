...
namespace ASEva.UIEto
{
    ...
    public class APIInfo
    {
        ...
        {
            return new Version(3, 3, 0, 0); // Update log / 更新记录: 新增App.ShowOpenFileDialog, ShowSaveFileDialog, ShowSelectFolderDialog, ShowColorDialog, ShowMessageBox, ShowQuestionBox接口
        }
