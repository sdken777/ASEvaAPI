 ...
 * \~English This document corresponds to API version: 2.11.6 \n\n
 * \~Chinese 本文档对应API版本：2.11.6 \n\n
 * 
...
namespace ASEva.UIEto
{
    ...
    public class APIInfo
    {
        ...
        {
            return new Version(2, 11, 6, 0); // Update log / 更新记录: 新增SnapshotExtensions.SnapshotFromScreen
        }
