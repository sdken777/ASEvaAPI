...
namespace ASEva.UIEto
{
    ...
    public class App
    {
        ...
        /// \~English
        /// <summary>
        /// (app:eto=2.16.1) Initialize application with the specified UI framework
        /// </summary>
