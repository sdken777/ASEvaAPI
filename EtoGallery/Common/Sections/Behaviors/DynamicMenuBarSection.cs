namespace Eto.Test.Sections.Behaviors
{
	...
	public class DynamicMenuBarSection : Panel, System.ComponentModel.INotifyPropertyChanged
	{
		...
		MenuItem CurrentMenuItem
		{
			...
			set
			{
				...
				PropertyChanged?.Invoke(this, new System.ComponentModel.PropertyChangedEventArgs(nameof(CurrentMenuItem)));
			}
		}
