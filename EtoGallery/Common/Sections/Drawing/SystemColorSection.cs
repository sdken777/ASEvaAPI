namespace Eto.Test.Sections.Drawing
{
	...
	public class SystemColorSection : Panel, System.ComponentModel.INotifyPropertyChanged
	{
		...
		ControlType SelectedControlType
		{
			...
			set
			{
				...
				PropertyChanged?.Invoke(this, new System.ComponentModel.PropertyChangedEventArgs(nameof(SelectedControlType)));
			}
		}
