namespace Eto.Test.Sections.Controls
{
	...
	public class ColorPickerSection : Panel, System.ComponentModel.INotifyPropertyChanged
	{
		bool allowAlpha;
		...
		public bool AllowAlpha
		{
			...
			set
			{
				...
				{
					allowAlpha = value;
					PropertyChanged?.Invoke(this, new System.ComponentModel.PropertyChangedEventArgs(nameof(AllowAlpha)));
				}
			}
		}
