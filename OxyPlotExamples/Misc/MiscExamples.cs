...
namespace ExampleLibrary
{
    ...
    public static class MiscExamples
    {
        ...
        public static PlotModel MatrixSeriesWest0479()
        {
            ...
            using (var reader = new StreamReader(typeof(MiscExamples).GetTypeInfo().Assembly.GetManifestResourceStream("west0479.mtx")))
            {
        ...
        public static PlotModel TrainSchedule()
        {
            ...
            var assembly = typeof(MiscExamples).GetTypeInfo().Assembly;
            using (var reader = new StreamReader(assembly.GetManifestResourceStream("Bergensbanen.csv")))
