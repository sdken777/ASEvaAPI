    ...
    partial class EtoTestPanel
    {
        private void initDrawDefault2D(TabPage tabPage)
        {
            ...
            drawableDefault2D.Paint += (o, args) =>
            {
                ...
                if (DateTime.Now.Second % 2 == 0) g.DrawString(t["draw-text"], f, Colors.Black, TextAnchor.BottomRight, 100, 120);
                else
                {
                ...
                var textSize = g.MeasureString(f, t["draw-text"]);
        ...
        private List<FloatPoint> drawPoints = [];
    }
}