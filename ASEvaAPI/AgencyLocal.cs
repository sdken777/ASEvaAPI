...
namespace ASEva
{
    ...
    public interface AgencyLocalHandler
    {
        ...
        bool TransformCurrentDialog(object dialog, String transformID);
        bool TransformWindow(object window, String transformID);
    ...
    public class AgencyLocal
    {
        ...
        /// \~English
        /// <summary>
        /// (api:app=3.2.10) Show a modal dialog to select bus message
        /// </summary>
        ...
        /// \~English
        /// <summary>
        /// (api:app=3.2.10) Show a modal dialog to select multiple bus messages at once
        /// </summary>
        ...
        /// \~Chinese
        /// <summary>
        /// (api:app=3.2.10) 打开对话框一次性选择多个总线报文
        /// </summary>
        ...
        /// \~English
        /// <summary>
        /// (api:app=3.2.10) Show a modal dialog to select signal
        /// </summary>
        ...
        /// \~English
        /// <summary>
        /// (api:app=3.2.10) Show a modal dialog to select multiple signals at once
        /// </summary>
        ...
        {
            return Handler.TransformCurrentDialog(dialog, transformID);
        }
        ...
        {
            return Handler.TransformWindow(window, transformID);
        }
