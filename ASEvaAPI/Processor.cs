...
namespace ASEva
{
    ...
    /// \~English
    /// <summary>
    /// (api:app=2.0.0) Output sample of processor
    /// </summary>
    /// \~Chinese
    /// <summary>
    ...
    /// \~English
    /// <summary>
    /// (api:app=2.0.0) Processor. Created while session starting, released while session stopping
    /// </summary>
    /// \~Chinese
    /// <summary>
    /// (api:app=2.0.0) 数据处理对象。在每轮Session开始时创建，结束时销毁
    /// </summary>
