 ...
 * 
 * \~English This document corresponds to API version: 2.15.4 \n
 * \~Chinese 本文档对应API版本：2.15.4
 */
...
namespace ASEva
{
    ...
    public class APIInfo
    {
        ...
        {
            return new Version(2, 15, 4, 0); // Update log / 更新记录: ConsoleIO移除noticeID和requestID(通过machineText控制)，新增ConsoleFileResult。新增Agency.GetPreviewJpeg。新增Agency.StartRemote(controller)
        }
