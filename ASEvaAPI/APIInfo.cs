...
namespace ASEva
{
    ...
    public class APIInfo
    {
        ...
        {
            return new Version(2, 15, 0, 0); // Update log / 更新记录: 新增ConsoleClass，ConsoleClassInfo。新增Agency.RunConsole, GetConsoleClassTable, GetConsoleClassInfo。新增MainWorkflow.OnRunConsole。明确caller适用范围
        }
