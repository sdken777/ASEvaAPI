 ...
 * 
 * \~English This document corresponds to API version: 2.15.3 \n
 * \~Chinese 本文档对应API版本：2.15.3
 */
...
namespace ASEva
{
    ...
    public class APIInfo
    {
        ...
        {
            return new Version(2, 15, 3, 0); // Update log / 更新记录: ConsoleClass.RunConsole接口变更，增加machineText参数
        }
