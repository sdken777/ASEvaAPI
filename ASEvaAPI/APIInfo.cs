 ...
 * 
 * \~English This document corresponds to API version: 2.16.7 \n
 * \~Chinese 本文档对应API版本：2.16.7
 */
...
namespace ASEva
{
    ...
    public class APIInfo
    {
        ...
        {
            return new Version(2, 16, 7, 0); // Update log / 更新记录: 新增Agency.SelectBusMessages, MainWorkflow.OnSelectBusMessages
        }
