 ...
 *
 * \~English This document corresponds to API version: 3.4.6 \n
 * \~Chinese 本文档对应API版本：3.4.6
 */
...
namespace ASEva
{
    ...
    public class APIInfo
    {
        ...
        {
            return new Version(3, 4, 6, 0); // Update log / 更新记录: 新增CommonWorkflow.OnGetPreferenceVariables
        }
