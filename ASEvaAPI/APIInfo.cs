 ...
 * 
 * \~English This document corresponds to API version: 2.15.7 \n
 * \~Chinese 本文档对应API版本：2.15.7
 */
...
namespace ASEva
{
    ...
    public class APIInfo
    {
        ...
        {
            return new Version(2, 15, 7, 0); // Update log / 更新记录: SampleCsvLoader/Writer继承IDisposable
        }
