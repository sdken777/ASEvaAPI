 ...
 * 
 * \~English This document corresponds to API version: 2.16.6 \n
 * \~Chinese 本文档对应API版本：2.16.6
 */
...
namespace ASEva
{
    ...
    public class APIInfo
    {
        ...
        {
            return new Version(2, 16, 6, 0); // Update log / 更新记录: 新增InstallPluginLibraryInfo.InstalledStatus
        }
