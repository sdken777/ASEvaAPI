 ...
 *
 * \~English This document corresponds to API version: 3.1.4 \n
 * \~Chinese 本文档对应API版本：3.1.4
 */
...
namespace ASEva
{
    ...
    public class APIInfo
    {
        ...
        {
            return new Version(3, 1, 4, 0); // Update log / 更新记录: ConsoleClass/DialogClass/ModuleConfig部分方法改为异步
        }
