 ...
 * 
 * \~English This document corresponds to API version: 2.15.1 \n
 * \~Chinese 本文档对应API版本：2.15.1
 */
...
namespace ASEva
{
    ...
    public class APIInfo
    {
        ...
        {
            return new Version(2, 15, 1, 0); // Update log / 更新记录: 增加ConsoleClass.GetRelatedConfigStatus/GetRelatedChildConfigStatus。新增Agency.GetConsoleRelatedModulesConfigStatus
        }
