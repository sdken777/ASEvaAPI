 ...
 *
 * \~English This document corresponds to API version: 3.1.6 \n
 * \~Chinese 本文档对应API版本：3.1.6
 */
...
namespace ASEva
{
    ...
    public class APIInfo
    {
        ...
        {
            return new Version(3, 1, 6, 0); // Update log / 更新记录: XXXClass.GetXXXName改为返回Dictionary<Language, String>
        }
