 ...
 *
 * \~English This document corresponds to API version: 3.2.14 \n
 * \~Chinese 本文档对应API版本：3.2.14
 */
...
namespace ASEva
{
    ...
    public class APIInfo
    {
        ...
        {
            return new Version(3, 2, 14, 0); // Update log / 更新记录: MonitoringFlag相关API移动至AgencyAsync
        }
