 ...
 * 
 * \~English This document corresponds to API version: 3.0.3 \n
 * \~Chinese 本文档对应API版本：3.0.3
 */
...
namespace ASEva
{
    ...
    public class APIInfo
    {
        ...
        {
            return new Version(3, 0, 3, 0); // Update log / 更新记录: OffsetSync移动至Timestamp，以及相应更改。
        }
