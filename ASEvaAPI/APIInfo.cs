...
namespace ASEva
{
    ...
    public class APIInfo
    {
        ...
        {
            return new Version(3, 0, 1, 0); // Update log / 更新记录: 移除Agency.IsGPURenderingDisabled/IsOnscreenGPURenderingEnabled，MainWorkflow.OnCheckDisableGPURendering/OnCheckEnableOnscreenGPURendering
        }
