 ...
 * 
 * \~English This document corresponds to API version: 2.15.8 \n
 * \~Chinese 本文档对应API版本：2.15.8
 */
...
namespace ASEva
{
    ...
    public class APIInfo
    {
        ...
        {
            return new Version(2, 15, 8, 0); // Update log / 更新记录: Agency.OpenProject增加force参数
        }
