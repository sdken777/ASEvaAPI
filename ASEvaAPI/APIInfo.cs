 ...
 *
 * \~English This document corresponds to API version: 3.9.1 \n
 * \~Chinese 本文档对应API版本：3.9.1
 */
...
namespace ASEva
{
    ...
    public class APIInfo
    {
        ...
        {
            return new Version(3, 9, 1, 0); // Update log / 更新记录: 新增Plugin.GetWorkflow(clientSide)
        }
