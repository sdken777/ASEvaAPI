 ...
 * 
 * \~English This document corresponds to API version: 3.0.2 \n
 * \~Chinese 本文档对应API版本：3.0.2
 */
...
namespace ASEva
{
    ...
    public class APIInfo
    {
        ...
        {
            return new Version(3, 0, 2, 0); // Update log / 更新记录: 移除Agency.GetBusFloat32Signals/GetOfflineMapImage/ConvertImageToCommon/ConvertImageToPlatform。移除PlatformImageType。移除旧VideoFrameGetter接口
        }
