 ...
 *
 * \~English This document corresponds to API version: 3.1.5 \n
 * \~Chinese 本文档对应API版本：3.1.5
 */
...
namespace ASEva
{
    ...
    public class APIInfo
    {
        ...
        {
            return new Version(3, 1, 5, 0); // Update log / 更新记录: Tuple改为简写形式。修正ConsoleIO.LoadFileData/SaveFileData
        }
