 ...
 *
 * \~English This document corresponds to API version: 3.2.11 \n
 * \~Chinese 本文档对应API版本：3.2.11
 */
...
namespace ASEva
{
    ...
    public class APIInfo
    {
        ...
        {
            return new Version(3, 2, 11, 0); // Update log / 更新记录: SessionIdentifier实现IComparable
        }
