 ...
 *
 * \~English This document corresponds to API version: 3.8.0 \n
 * \~Chinese 本文档对应API版本：3.8.0
 */
...
namespace ASEva
{
    ...
    public class APIInfo
    {
        ...
        {
            return new Version(3, 8, 0, 0); // Update log / 更新记录: 新增RawToSampleConfig, ModuleConfig和WindowClass新增GetRawToSampleConfigs方法。移除ProcessorClass.GetRawToSampleProtocols方法
        }
