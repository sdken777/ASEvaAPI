 ...
 *
 * \~English This document corresponds to API version: 3.7.9 \n
 * \~Chinese 本文档对应API版本：3.7.9
 */
...
namespace ASEva
{
    ...
    public class APIInfo
    {
        ...
        {
            return new Version(3, 7, 9, 0); // Update log / 更新记录: 新增TransformCurrentDialog/Window
        }
