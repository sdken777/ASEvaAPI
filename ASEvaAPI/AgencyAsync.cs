...
namespace ASEva
{
    ...
    public class AgencyAsync
    {
        ...
        /// \~English
        /// <summary>
        /// (api:app=3.5.0) Call native plugin's function
        /// </summary>
        ...
        /// \~English
        /// <summary>
        /// (api:app=3.9.3) Generate bus message for transmission by signal values
        /// </summary>
        ...
        public static Task<BusMessage> GenerateBusMessage(String messageID, Dictionary<String, double> signalValues, double defaultValue, uint? interval)
        {
