...
namespace ASEva.UICoreWF
{
    ...
    class AppHandlerCoreWF : AppHandler
    {
        public Application CreateApp(bool attach, out String uiBackend, out String webViewBackend)
        {
            ...
            FuncManager.Register("EnsureEtoSyncContext", delegate { if (SynchronizationContext.Current == null) SynchronizationContext.SetSynchronizationContext(new System.Windows.Forms.WindowsFormsSynchronizationContext()); return null; });
        ...
        {
            if (isDerivedFromType(platformWindowPanel, "ASEva.UIWpf.WindowPanel"))
            {
        ...
        {
            if (isDerivedFromType(platformConfigPanel, "ASEva.UIWpf.ConfigPanel"))
            {
