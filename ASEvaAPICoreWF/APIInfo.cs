 ...
 * \~English This document corresponds to API version: 3.1.1
 * \~Chinese 本文档对应API版本：3.1.1
 */
...
namespace ASEva.UICoreWF
{
    ...
    public class APIInfo
    {
        ...
        {
            return new Version(3, 1, 1, 0); // Update log / 更新记录: 新增CommonImageCoreWFExtensions
        }
    }
}
