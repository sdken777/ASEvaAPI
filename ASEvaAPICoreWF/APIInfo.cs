 ...
 * \~English This document corresponds to API version: 2.9.3
 * \~Chinese 本文档对应API版本：2.9.3
 */
...
namespace ASEva.UICoreWF
{
    ...
    public class APIInfo
    {
        ...
        {
            return new Version(2, 9, 3, 2); // Update log / 更新记录: 修正vertical StackLayout中无控件时初始化异常
        }
    }
}
