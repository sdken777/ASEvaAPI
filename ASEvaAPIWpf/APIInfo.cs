 ...
 * \~English This document corresponds to API version: 2.1.2
 * \~Chinese 本文档对应API版本：2.1.2
 */
...
namespace ASEva.UIWpf
{
    ...
    public class APIInfo
    {
        ...
        {
            return new Version(2, 1, 2, 0); // Update log / 更新记录: 新增CrossConvert.EnableWinformEmbedder
        }
