 ...
 * \~English This document corresponds to API version: 1.7.8
 * \~Chinese 本文档对应API版本：1.7.8
 */
...
namespace ASEva.UIWpf
{
    ...
    public class APIInfo
    {
        ...
        {
            return new Version(1, 7, 8, 0); // Update log / 更新记录: 修正LinkButton重复设置Text导致鼠标事件失效问题
        }
    }
}
