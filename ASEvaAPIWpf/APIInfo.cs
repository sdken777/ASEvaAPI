 ...
 * \~English This document corresponds to API version: 2.1.3
 * \~Chinese 本文档对应API版本：2.1.3
 */
...
namespace ASEva.UIWpf
{
    ...
    public class APIInfo
    {
        ...
        {
            return new Version(2, 1, 3, 0); // Update log / 更新记录: 修正CommonImageWpfExtensions命名空间
        }
