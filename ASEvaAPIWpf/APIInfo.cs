 ...
 * \~English This document corresponds to API version: 1.7.3
 * \~Chinese 本文档对应API版本：1.7.3
 */
...
namespace ASEva.UIWpf
{
    ...
    public class APIInfo
    {
        ...
        {
            return new Version(1, 7, 3, 0); // Update log / 更新记录: 支持TextTableViewCallback.OnSelectedRowChanged
        }
    }
}
