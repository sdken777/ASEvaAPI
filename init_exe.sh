...
cp -vf "$CUR_DIR"/3party/eto/*.* "$CUR_DIR"/binma/
cp -vf "$CUR_DIR"/3party/eto/*.* "$CUR_DIR"/binma/debug/
...
cp -vf "$CUR_DIR"/3party/macos-arm64/*.* "$CUR_DIR"/binma/
cp -vf "$CUR_DIR"/3party/macos-arm64/*.* "$CUR_DIR"/binma/debug/

cp -vf "$CUR_DIR"/3party/macos-x64/*.* "$CUR_DIR"/binm/
cp -vf "$CUR_DIR"/3party/macos-x64/*.* "$CUR_DIR"/binm/debug/

cp -vf "$CUR_DIR"/3party/macos-skia-native/*.* "$CUR_DIR"/binm/
cp -vf "$CUR_DIR"/3party/macos-skia-native/*.* "$CUR_DIR"/binm/debug/
cp -vf "$CUR_DIR"/3party/macos-skia-native/*.* "$CUR_DIR"/binma/
cp -vf "$CUR_DIR"/3party/macos-skia-native/*.* "$CUR_DIR"/binma/debug/

cp -vf "$CUR_DIR"/3party/monomac/*.* "$CUR_DIR"/binm/
cp -vf "$CUR_DIR"/3party/monomac/*.* "$CUR_DIR"/binm/debug/
cp -vf "$CUR_DIR"/3party/monomac/*.* "$CUR_DIR"/binma/
cp -vf "$CUR_DIR"/3party/monomac/*.* "$CUR_DIR"/binma/debug/
